package chooongg.box.bus

import androidx.lifecycle.MutableLiveData
import chooongg.box.bus.event.DefaultEvent
import chooongg.box.bus.event.Event
import chooongg.box.bus.event.StickinessEvent
...
object LiveDataBus {
     ...
     * @param data 事件内容
     */
    fun send1(tags: List<Int>, data: List<Any>) {
