...
fun Context.resourcesTextArray(@ArrayRes id: Int) = resources.getTextArray(id)
fun Context.resourcesStringArray(@ArrayRes id: Int) = resources.getStringArray(id)
...
fun Context.resourcesAnimation(@AnimRes id: Int) = AnimationUtils.loadAnimation(this, id)