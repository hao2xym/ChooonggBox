...
import chooongg.box.picker.models.BaseFile
import chooongg.box.picker.models.FileType
...
object PickerManager {
    ...
    var cameraDrawable = R.drawable.layer_camera
    ...
    fun addDocTypes() {
        ...
        fileTypes.add(FileType(FilePickerConst.PDF, pdfs, R.drawable.ic_picker_pdf))

        val docs = arrayOf("doc", "docx", "dot", "dotx")
        fileTypes.add(FileType(FilePickerConst.DOC, docs, R.drawable.ic_picker_doc))

        val ppts = arrayOf("ppt", "pptx")
        fileTypes.add(FileType(FilePickerConst.PPT, ppts, R.drawable.ic_picker_ppt))

        val xlss = arrayOf("xls", "xlsx")
        fileTypes.add(FileType(FilePickerConst.XLS, xlss, R.drawable.ic_picker_xls))

        val txts = arrayOf("txt")
        fileTypes.add(FileType(FilePickerConst.TXT, txts, R.drawable.ic_picker_txt))
    }
