...
object RomUtils {
    ...
    fun isHuawei() = ROM_HUAWEI[0].equals(getRomInfo().name)
    fun isVivo() = ROM_VIVO[0].equals(getRomInfo().name)
    fun isXiaomi() = ROM_XIAOMI[0].equals(getRomInfo().name)
    fun isOppo() = ROM_OPPO[0].equals(getRomInfo().name)
    fun isLeeco() = ROM_LEECO[0].equals(getRomInfo().name)
    fun is360() = ROM_360[0].equals(getRomInfo().name)
    fun isZte() = ROM_ZTE[0].equals(getRomInfo().name)
    fun isOneplus() = ROM_ONEPLUS[0].equals(getRomInfo().name)
    fun isNubia() = ROM_NUBIA[0].equals(getRomInfo().name)
    fun isCoolpad() = ROM_COOLPAD[0].equals(getRomInfo().name)
    fun isLg() = ROM_LG[0].equals(getRomInfo().name)
    fun isGoogle() = ROM_GOOGLE[0].equals(getRomInfo().name)
    fun isSamsung() = ROM_SAMSUNG[0].equals(getRomInfo().name)
    fun isMeizu() = ROM_MEIZU[0].equals(getRomInfo().name)
    fun isLenovo() = ROM_LENOVO[0].equals(getRomInfo().name)
    fun isSmartisan() = ROM_SMARTISAN[0].equals(getRomInfo().name)
    fun isHtc() = ROM_HTC[0].equals(getRomInfo().name)
    fun isSony() = ROM_SONY[0].equals(getRomInfo().name)
    fun isGionee() = ROM_GIONEE[0].equals(getRomInfo().name)
    fun isMotorola() = ROM_MOTOROLA[0].equals(getRomInfo().name)
